...
function Dong-GuideData([string]$Slug) {
  $data = @{
    "junggok-dong" = @{
      ...
      Nearby = @(
        @{ H = "중곡역 인근"; P = "중곡역 인근은 중곡동 문의에서 가장 먼저 확인하는 생활권입니다. 역과 가까운 오피스텔, 숙소, 주거지라도 실제 방문 가능 여부는 상세 주소와 예약 시간에 따라 달라질 수 있습니다." },
        @{ H = "군자역 인근"; P = "군자역 인근은 중곡동과 군자동 생활권이 이어지는 구간입니다. 환승역 주변은 시간대별 이동 상황이 달라질 수 있어 상담 시 군자역 기준인지, 중곡동 안쪽 주소인지 함께 확인합니다." },
        @{ H = "용마산로·긴고랑로 생활권"; P = "용마산로와 긴고랑로 주변은 주거지 안쪽 주소가 많아 공동현관, 주차 가능 여부, 연락 가능한 번호를 미리 확인하는 것이 좋습니다." },
        @{ H = "중곡1동·중곡2동·중곡3동·중곡4동 통합 안내"; P = "중곡1동부터 중곡4동까지 중곡동 페이지 안에서 통합 안내합니다. 세부 행정동보다 실제 주소와 방문 환경이 예약 판단에 더 중요합니다." },
      ...
      Intro = "중곡동은 중곡역, 군자역 인근 생활권과 연결되어 주거지, 숙소, 오피스텔 방문 문의가 많은 지역입니다.";
      Faqs = @(
...
function Dong-Content($d, $r) {
  ...
  return StandardContent "동별 안내" "<span class=""grad"">$($d.Title)</span><br>예약 안내" $lead $sections $g.Faqs
}
...
<section class="block"><div class="wrap content"><span class="eyebrow">REVIEWS</span><h2 class="sec">이용 후기</h2><p class="sec-lead">후기는 실제 후기만 사용하는 것이 원칙입니다. 동일 문장 반복을 피하고 상세 후기는 후기 페이지에서 관리합니다.</p><div class="grid g3"><a class="card" href="/reviews/"><div class="k">REVIEW</div><h3>전체 후기</h3><p>실제 접수된 후기 기준으로 운영 시 추가합니다.</p></a><a class="card" href="/reviews/area/"><div class="k">AREA</div><h3>지역별 후기</h3><p>권역별 이용 맥락을 자연스럽게 정리합니다.</p></a><a class="card" href="/reviews/stations/"><div class="k">STATION</div><h3>역세권 후기</h3><p>역명 나열보다 예약 상황 중심으로 작성합니다.</p></a></div></div></section>
